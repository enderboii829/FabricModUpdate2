package net.enderboii829.firstmod.util;
        ...
        LootTableEvents.MODIFY.register((resourceManager, lootManager, id, tableBuilder, source) -> {
            if(GRASS_BLOCK_ID.equals(id)) {
                LootPool.Builder poolBuilder = LootPool.builder()
                        ...
                        .with(ItemEntry.builder(ModItems.CHERRY_SEEDS))
                ...
                LootPool.Builder poolBuilder = LootPool.builder()
                        ...
                        .conditionally(EntityPropertiesLootCondition.builder(LootContext.EntityTarget.KILLER,
                                new EntityPredicate.Builder().equipment(EntityEquipmentPredicate.Builder.create()
                                        .mainhand(ItemPredicate.Builder.create().items(Items.STONE_SWORD).build()).build()).build()))
