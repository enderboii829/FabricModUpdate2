package net.enderboii829.firstmod.villager;
...
public class ModVillagers {
    ...
    public static final VillagerProfession JUMP_MASTER = registerProfession("jumpmaster",
            RegistryKey.of(Registry.POINT_OF_INTEREST_TYPE_KEY, new Identifier(FirstMod.MOD_ID, "jumpy_poi")));


    public static final VillagerProfession registerProfession(String name, RegistryKey<PointOfInterestType> type){
        return Registry.register(Registry.VILLAGER_PROFESSION, new Identifier(FirstMod.MOD_ID, name),
